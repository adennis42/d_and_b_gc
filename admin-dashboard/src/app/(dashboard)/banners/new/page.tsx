      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-slate-400">
            Create a customizable banner to display special offers and promotions on your website.
          </p>
        </div>
                          ...
                          return (
                            <SelectItem key={icon} value={icon} className="text-slate-100 hover:bg-slate-800 focus:bg-slate-800">
                              <div className="flex items-center gap-2">
                                {Icon && icon !== 'none' && <Icon className="w-4 h-4" />}
                                <span>{icon === 'none' ? 'None' : icon}</span>
                              </div>
                            </SelectItem>
                          );
                        })}
